...
class debugMonitor {
public:
	debugMonitor(PinName knobPin, EncodedMotor* motorPtr, PinName I2C1_SDA = PB_9, PinName I2C1_SDL = PB_8, uint16_t lcdAddr = 0X3F, TextLCD::LCDType lcdtype = TextLCD::LCD20x4);
	void printSignal(); 
